...
class SQLErrorItemListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        byte[] newRequest = do_SQL_Error(request, selectString, action, selectedIndex);
        req.setRequest(newRequest);
    }
    
    public byte[] do_SQL_Error(byte[] request, String selectedString, String action, int[] selectedIndex){
